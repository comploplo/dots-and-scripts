...
$if(problemtitle)$
\newcommand{\problemDenotation}{$problemtitle$}
$else$ 
...
\newcommand{\byFA}{\hfill (by FA)} 
\newcommand{\byTN}{\hfill (by TN)} 
\newcommand{\byNN}{\hfill (by NN)} 
\newcommand{\byPM}{\hfill (by PM)} 
\newcommand{\byPA}{\hfill (by PA)} 
\newcommand{\byB}{\hfill (by $$\beta$$ reduction)} 
\newcommand{\Lb}[1]{$$\text{[}_{\text{#1}}$$ } %A more convenient left bracket
\newcommand{\Rb}[1]{$$\text{]}_{\text{#1}}$$ } %A more convenient left bracket
\newcommand{\brc}[1]{$$\llbracket$$#1$$\rrbracket$$}
\newcommand{\gap}{\underline{\hspace{1.2em}}}
\newcommand{\hd}{$$^{\circ}$$\xspace} %Symbol for printing head / degree symbol
\renewcommand{\iff}{T \textit{iff}}
...
\newcommand{\sssr}[1]{\subsubsection{\hfill #1}}
...
\setkomafont{subsubsection}{\large\fontfamily{phv}}
