...
--------------------------------------------------------------------------------------------------
----- scratchpad config, depends on scripts from gh                                          -----
--------------------------------------------------------------------------------------------------
    --
myScratchPads :: [NamedScratchpad]
myScratchPads = [ NS "barpad1" "kitty --name=barpad1 --config=/home/gabe/.config/kitty/sml-kitty.conf /home/gabe/.scripts/less-wtr" (resource =? "barpad1") (manageBar1)
   ...
   ,NS "term" spawnTerm (resource =? "dropdown-terminal") (manageRightThird) ]
    where
...
myKeys = [ ("M-<Return>", spawn myTerminal)
    ...
    where nonNSP         = WSIs (return (\ws -> W.tag ws /= "nsp"))
          ...
          scratchpads    = do {
              namedScratchpadAction myScratchPads "barpad1" ;
